    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6">
            ...
            <div class="space-y-3">
                ...
                @if($clientMessage)<p class="text-xs text-green-600">{{ $clientMessage }}</p>@endif
                @if($clientError)<p class="text-xs text-red-600">{{ $clientError }}</p>@endif
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6">
            ...
            <div class="space-y-3">
                ...
                <button wire:click="sendInvite" wire:loading.attr="disabled"
                    class="w-full flex items-center justify-center gap-1.5 py-2 text-sm bg-[#FC54AA] hover:bg-[#E0429A] text-white rounded-lg transition-colors disabled:opacity-60">
                    <svg wire:loading.remove wire:target="sendInvite" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    <svg wire:loading wire:target="sendInvite" class="animate-spin" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
